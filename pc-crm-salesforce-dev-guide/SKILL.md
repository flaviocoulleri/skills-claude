---
name: pc-crm-salesforce-dev-guide
...
<!-- Changelog
1.2.0 (2026-04-25): Bump menor por aplicación de convención de naming pc-[área]-[sistema]-[objeto]-[acción]. Renombrado desde `salesforce-developer` → `pc-crm-salesforce-dev-guide`. Sin cambios funcionales.
1.1.0: versión previa al rename.
-->
